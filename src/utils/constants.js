...
export const locationOpt = [
  ...
  { value: "ayt", label: "Antalya Havalimanı (AYT/LTAI)" },
  { value: "yei", label: "Bursa Yenişehir Havalimanı (YEI/LTBR)" },
  { value: "diy", label: "Diyarbakır Havalimanı (DIY/LTCC)" },
  { value: "ezs", label: "Elazığ Havalimanı (EZS/LTCA)" },
